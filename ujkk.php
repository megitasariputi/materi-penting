...
<body>
    ...
    // {
    //     if ($email == 'admin' OR $email == 'admin@gmail.com' AND $pass == '12345') {
    //         $hasil = true;
    ...
    <?php
    if (isset($_POST['masuk'])) {
        if (($_POST['eml'] == 'admin' OR $_POST['eml'] == 'admin@gmail.com') AND $_POST['psw'] == 12345) {
            echo 'Halo Admin, Email dan Password yang anda masukan benar.';
        } elseif (($_POST['eml'] == 'user' OR $_POST['eml'] == 'useradmin@gmail.com') AND $_POST['psw'] == 'abcde') {
            echo 'Halo User, Email dan Password yang anda masukan benar.';
        } else {
            echo 'Halo, Email dan Password yang anda masukan salah.';
        }
